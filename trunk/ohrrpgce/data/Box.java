...
public class Box {
     ...
     */
    public Box (int width, int height, int bgColor) {
        resize(width, height);
     ...
     */
    public Box (int width, int height, int bgColor, int[] borderColors) {
    ...
    public void fillBackground(int bgColor) {
        //Fill in.
    ...
    public void drawBorders(int[] borderColors) {
