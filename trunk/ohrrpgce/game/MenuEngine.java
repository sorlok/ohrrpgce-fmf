...
public class MenuEngine extends Engine {
   ...
   // public static String gameName;
    ...
    private int width;
    private int height;
    private int darkenInterval = 4; //ticks
    ...
    public void reset() {
        ...
        currCursor.setPosition(currCursor.getPosX()+mainMenu.getPosX(), /*currCursor.getPosY()+*/mainMenu.getPosY()) ;
